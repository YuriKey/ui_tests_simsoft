...
│    ├── TS12_sample_form_interface                 # Проверка регистрации пользователя.
│    ├── TS13_manager_account                       # Проверка функционала аккаунта менеджера банка.                 
│    ├── TS14_customer_account                      # проверка функционала акаунта пользователя.
